...
@Entity
@Table(name = "t_apply_define_instance", schema = "pobo_mhall", catalog = "")
public class ApplyDefineInstanceEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        ApplyDefineInstanceEntity that = (ApplyDefineInstanceEntity) o;
